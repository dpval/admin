            ...
            .then(async (userCredential) => {
                ...
                if (userDoc.exists()) {
                    ...
                    if (userType === "admin") {
                        ...
                        window.location.href = "dashboard.html"; // Non-admin redirect (e.g., client or applicant)
                    }
                } else {
                    console.error("No such user in Firestore!");
                    errorMessage.textContent = "User information not found. Please contact support.";
